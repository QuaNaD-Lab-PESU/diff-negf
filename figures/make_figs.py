...
plt.tight_layout(); plt.savefig(os.path.join(_FIG, "fig_barrier.png"),bbox_inches="tight"); plt.close()
...
plt.tight_layout(); plt.savefig(os.path.join(_FIG, "fig_convergence.png"),bbox_inches="tight"); plt.close()
...
plt.tight_layout(); plt.savefig(os.path.join(_FIG, "fig_rtd.png"),bbox_inches="tight"); plt.close()
...
plt.tight_layout(); plt.savefig(os.path.join(_FIG, "fig_grad.png"),bbox_inches="tight"); plt.close()

# ---------- Fig 5: FNO surrogate ----------
# Generated by surrogate/evaluate_worstcase.py, which draws it from the
# retrained weights so the figure label and the reported metric cannot
# drift apart. Do not duplicate the plotting code here.
...
plt.tight_layout(); plt.savefig(os.path.join(_FIG, "fig_inverse.png"),bbox_inches="tight"); plt.close()
